...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'FeaturedProduct.description'
        db.delete_column(u'djangocms_oscar_featuredproduct', 'description')

        # Deleting field 'FeaturedProduct.title'
        db.delete_column(u'djangocms_oscar_featuredproduct', 'title')


    def backwards(self, orm):
        # Adding field 'FeaturedProduct.description'
        db.add_column(u'djangocms_oscar_featuredproduct', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'FeaturedProduct.title'
        db.add_column(u'djangocms_oscar_featuredproduct', 'title',
    ...
    models = {
        ...
        u'djangocms_oscar.featuredproduct': {
            'Meta': {'object_name': 'FeaturedProduct', '_ormbases': ['cms.CMSPlugin']},
            u'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'}),
            'product': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['catalogue.Product']"})
        }
    }

    complete_apps = ['djangocms_oscar']